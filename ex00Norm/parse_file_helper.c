...
/*   Updated: 2025/06/08 20:55:36 by phonekha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	norme_ft_get_line_len_loop(int *total_lines,
	int file, int *file_sizes, char c)
{
	int		i;
	int		line_idx;
...
int	*ft_get_lines_len_loop(int file, int *file_sizes)
{
	...
	norme_ft_get_line_len_loop(&total_lines, file, file_sizes, c);
	return (file_sizes);
}
